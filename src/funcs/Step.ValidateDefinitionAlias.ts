import type { DefinitionAliasValidator } from "@/services/DefinitionAliasValidator.Interface";
import type { Step } from "./Step.Interface";
import type {
  AliasValidateResultReporter,
  ValidationIssue,
  ValidationSummary,
} from "@/services/AliasValidateResultReporter.Interface";

export class StepValidateDefinitionAlias implements Step {
  constructor(
    private readonly validators: DefinitionAliasValidator[],
    private readonly reporter: AliasValidateResultReporter,
  ) {}
